...
Private key input may be in PKCS#1 (ASN.1 `RSAPrivateKey` type, PEM `RSA PUBLIC KEY` type) or PKCS#8 (ASN.1 `PrivateKeyInfo` type, PEM `PRIVATE KEY` type) ASN.1 DER forms.
